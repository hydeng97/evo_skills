...
- Shared templates live under `memory/coach.clear-thinking.decision-review.v1/shared/`
- User-specific memories live under `memory/coach.clear-thinking.decision-review.v1/users/<user_id>/`
